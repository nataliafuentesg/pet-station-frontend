        ...
        <div class="lg:col-span-7 flex flex-col">
          ...
          <div class="bg-ps-blue text-white rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-12 shadow-2xl mt-auto">
            ...
            <div class="flex flex-col gap-3" v-if="TIENDA_ACTIVA">
              ...
              <div v-if="product.stock > 0" class="flex gap-3">
                ...
                <a :href="whatsappUrl" target="_blank"
                  @click="track('WHATSAPP_PRODUCTO', { productoId: product.id, nombre: product.nombre, precio: product.precio })"
              ...
              <div v-else class="space-y-3">
                ...
                <button @click="abrirWhatsappAgotado"
            ...
            <div v-else class="space-y-3">
              ...
              <a :href="whatsappUrl" target="_blank"
                @click="track('WHATSAPP_PRODUCTO', { productoId: product.id, nombre: product.nombre, precio: product.precio, origen: 'tienda_pausada' })"
...
const abrirWhatsappAgotado = () => {
  if (!product.value) return;
  track('AGOTADO_CONSULTAR', { productoId: product.value.id, nombre: product.value.nombre });
