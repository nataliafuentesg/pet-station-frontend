      ...
      <div class="max-w-[1800px] mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 md:gap-5">
          ...
          <button @click="isCartOpen = true" class="relative p-2 hover:scale-110 transition-transform">
            ...
            <span v-if="cartStore.cartCount > 0" class="absolute -top-1 -right-1 bg-ps-red text-white text-[9px] font-black w-5 h-5 rounded-full flex items-center justify-center border-2 border-white dark:border-black animate-in zoom-in duration-300">
              {{ cartStore.cartCount }}
            </span>
          </button>
